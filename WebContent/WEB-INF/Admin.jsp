					...
					<nav id="site-nav" class="site-nav">
						<ul>
							...
							<li id="nav-item-tv" class="nav-item-2"><a class="nav-link"
								href="/CarRent/main.html"">LogOut</a>
							</li>
			...
			<div class="col-md-6">
				<form method="get" action="/CarRent/Manage">
					...
					<div class="form-group col-lg-12">
						<label>Car ID</label> <input type="" name="updatecarid"  data-toggle="popover" title="Pay Attantion" data-content=" If the Car ID is exist you will update the car data!"
							class="form-control" id="" type="numbersOnly" pattern="[0-9.]+" value="" required>
					</div>
					...
					<div class="form-group col-lg-12">
						...
						<button type="submit" class="btn btn-warning" data-toggle="tooltip" title="Pay attantion- If the Car ID is exist you will update the car data!" >Update/Add</button>
					</div>
				</form>
			</div>
			<div class="col-md-6">
